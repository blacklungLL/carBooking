    ...
    <div className="container-fluid">
      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-6 mt-4">
            <div className="banner-content" style={{ backgroundColor: "#3563E9", height: "360px", borderRadius: "10px"}}>
                <div className="p-4 text-white">
                    <h2 className="fw-bold">Sports car with the best design and acceleration</h2>
